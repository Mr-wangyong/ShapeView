 ...
 * Time: 下午5:07
 */
public class ShapeViewProxy {

    public static void proxyShapeAttributes(View view, Context context, AttributeSet attrs, int defStyle) {
        ...
        float strokeWidth = typedArray.getDimension(R.styleable.ShapeView_strokeShapeWidth, 0);
        int strokeColor = typedArray.getColor(R.styleable.ShapeView_strokeShapeColor, 0);
